...
public class EntityUtil {
    ...
    private static int spawnPacket(Location loc) throws Exception {
        ...
        Reflections.getMethod(enderCrystalClass, "setLocation", double.class, double.class, double.class, float.class, float.class)
                .invoke(crystal, loc.getX(), loc.getY(), loc.getZ(), 0, 0);
