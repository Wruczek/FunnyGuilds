    ...
    private static class FakeDragon {
        ...
        public Object getSpawnPacket() {
            ...
            try {
                ...
                Reflections.getMethod(EntityEnderDragon, "setLocation", double.class, double.class, double.class, float.class, float.class)
        ...
        public Object getTeleportPacket(Location loc) {
            try {
                ...
                return packetClass.getConstructor(new Class<?>[] {int.class, int.class, int.class, int.class, byte.class, byte.class}).newInstance(
                        this.id, loc.getBlockX() * 32, loc.getBlockY() * 32, loc.getBlockZ() * 32, (byte) ((int) loc.getYaw() * 256 / 360),
